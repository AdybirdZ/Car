...
#define TASK3_POSITIVE_REVERSE_POSITION_CM (1.7f)  // 到达此位置后由正向运动切换为负向运动
...
#define TASK3_NEGATIVE_HOLD_ANGLE_OFFSET (-2.0f)   // -5cm位置的额外静态倾角偏置，数字越小越偏向步进电机
...
#define TASK4_ACCEL_TIME_TICKS          (150U)     // 1.5秒S曲线缓慢起步
#define TASK4_DECEL_TIME_TICKS          (150U)     // 最后1.5秒S曲线缓慢停车
